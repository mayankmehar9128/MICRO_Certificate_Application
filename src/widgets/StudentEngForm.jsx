...
const StudentEngForm = () => {
  ...
  const sendFormData = async (event) => {
    ...
    // get our form data
    const studentenqformData = new FormData(formRef.current)
        ...
        <form ref={formRef} onSubmit={sendFormData}>
            <div className="grid grid-cols-2 gap-7">
                <div className="flex flex-col">
                    <label htmlFor="nameInput" className="pb-2 text-[#003F7D]">Student Name *</label>
                    <FormTextField type={"text"} id={"nameInput"} name={"name"} placeholder={"your name"}/>
                    {/* <input type="text" id="nameInput" name="name" /> */}
                </div>
                <div className="flex flex-col">
                    <label htmlFor="fathernameInput" className="pb-2 text-[#003F7D]">Father Name *</label>
                    <FormTextField type={"text"} id={"fathernameInput"} name={"fathername"} placeholder={"father name"}/>
                    {/* <input type="text" id="nameInput" name="name" /> */}
                </div>
                <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    <label htmlFor="qualificationInput" className="pb-2 text-[#003F7D]">Qualification</label>
                    <FormTextField type={"text"} id={"qualificationInput"} name={"qualification"} placeholder={"type qualificaton"}/>
                    {/* <input type="text" id="nameInput" name="name" /> */}
                </div>
            </div>
